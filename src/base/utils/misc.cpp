    ...
    switch (locale.language()) {
        ...
        case QLocale::Chinese:
            switch (locale.country()) {
                ...
                default:
                    return C_LOCALE_CHINESE_TRADITIONAL_TW;
            }
...
QString Utils::Misc::boostVersionString() {
    ...
    static const QString ver = u"%1.%2.%3"_s
            .arg(QString::number(BOOST_VERSION / 100000), QString::number((BOOST_VERSION / 100) % 1000), QString::number(BOOST_VERSION % 100));
    return ver;
}
