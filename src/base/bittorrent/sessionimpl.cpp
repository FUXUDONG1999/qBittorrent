...
SessionImpl::SessionImpl(QObject *parent)
        : Session(parent), m_isDHTEnabled(BITTORRENT_SESSION_KEY(u"DHTEnabled"_s), true), m_isLSDEnabled(BITTORRENT_SESSION_KEY(u"LSDEnabled"_s), true),
          m_isPeXEnabled(BITTORRENT_SESSION_KEY(u"PeXEnabled"_s), true), m_isIPFilteringEnabled(BITTORRENT_SESSION_KEY(u"IPFilteringEnabled"_s), false),
          m_isTrackerFilteringEnabled(BITTORRENT_SESSION_KEY(u"TrackerFilteringEnabled"_s), false), m_IPFilterFile(BITTORRENT_SESSION_KEY(u"IPFilter"_s)),
          m_announceToAllTrackers(BITTORRENT_SESSION_KEY(u"AnnounceToAllTrackers"_s), false),
          m_announceToAllTiers(BITTORRENT_SESSION_KEY(u"AnnounceToAllTiers"_s), true), m_asyncIOThreads(BITTORRENT_SESSION_KEY(u"AsyncIOThreadsCount"_s), 10),
          m_hashingThreads(BITTORRENT_SESSION_KEY(u"HashingThreadsCount"_s), 1), m_filePoolSize(BITTORRENT_SESSION_KEY(u"FilePoolSize"_s), 100),
          m_checkingMemUsage(BITTORRENT_SESSION_KEY(u"CheckingMemUsageSize"_s), 32), m_diskCacheSize(BITTORRENT_SESSION_KEY(u"DiskCacheSize"_s), -1),
          m_diskCacheTTL(BITTORRENT_SESSION_KEY(u"DiskCacheTTL"_s), 60), m_diskQueueSize(BITTORRENT_SESSION_KEY(u"DiskQueueSize"_s), (1024 * 1024)),
...
#endif
        , m_usePieceExtentAffinity(BITTORRENT_SESSION_KEY(u"PieceExtentAffinity"_s), false), m_isSuggestMode(BITTORRENT_SESSION_KEY(u"SuggestMode"_s), false),
          ...
          m_connectionSpeed(BITTORRENT_SESSION_KEY(u"ConnectionSpeed"_s), 30), m_socketSendBufferSize(BITTORRENT_SESSION_KEY(u"SocketSendBufferSize"_s), 0),
          ...
          m_outgoingPortsMin(BITTORRENT_SESSION_KEY(u"OutgoingPortsMin"_s), 0), m_outgoingPortsMax(BITTORRENT_SESSION_KEY(u"OutgoingPortsMax"_s), 0),
          m_UPnPLeaseDuration(BITTORRENT_SESSION_KEY(u"UPnPLeaseDuration"_s), 0), m_peerToS(BITTORRENT_SESSION_KEY(u"PeerToS"_s), 0x04),
          m_ignoreLimitsOnLAN(BITTORRENT_SESSION_KEY(u"IgnoreLimitsOnLAN"_s), false),
          m_includeOverheadInLimits(BITTORRENT_SESSION_KEY(u"IncludeOverheadInLimits"_s), false), m_announceIP(BITTORRENT_SESSION_KEY(u"AnnounceIP"_s)),
          ...
          m_btProtocol(BITTORRENT_SESSION_KEY(u"BTProtocol"_s), BTProtocol::Both, clampValue(BTProtocol::Both, BTProtocol::UTP)),
          ...
          m_isAddTrackersEnabled(BITTORRENT_SESSION_KEY(u"AddTrackersEnabled"_s), false), m_additionalTrackers(BITTORRENT_SESSION_KEY(u"AdditionalTrackers"_s)),
          ...
          m_refreshInterval(BITTORRENT_SESSION_KEY(u"RefreshInterval"_s), 1500), m_isPreallocationEnabled(BITTORRENT_SESSION_KEY(u"Preallocation"_s), false),
          ...
          m_saveResumeDataInterval(BITTORRENT_SESSION_KEY(u"SaveResumeDataInterval"_s), 60), m_port(BITTORRENT_SESSION_KEY(u"Port"_s), -1),
          m_networkInterface(BITTORRENT_SESSION_KEY(u"Interface"_s)), m_networkInterfaceName(BITTORRENT_SESSION_KEY(u"InterfaceName"_s)),
          m_networkInterfaceAddress(BITTORRENT_SESSION_KEY(u"InterfaceAddress"_s)), m_encryption(BITTORRENT_SESSION_KEY(u"Encryption"_s), 0),
          ...
          m_storedTags(BITTORRENT_SESSION_KEY(u"Tags"_s)), m_maxRatioAction(BITTORRENT_SESSION_KEY(u"MaxRatioAction"_s), Pause),
          ...
          m_isTrackerEnabled(BITTORRENT_KEY(u"TrackerEnabled"_s), false), m_peerTurnover(BITTORRENT_SESSION_KEY(u"PeerTurnover"_s), 4),
          ...
          m_excludedFileNames(BITTORRENT_SESSION_KEY(u"ExcludedFileNames"_s)), m_bannedIPs(u"State/BannedIPs"_s, QStringList(), Algorithm::sorted<QStringList>),
          m_resumeDataStorageType(BITTORRENT_SESSION_KEY(u"ResumeDataStorageType"_s), ResumeDataStorageType::Legacy),
          m_isMergeTrackersEnabled(BITTORRENT_KEY(u"MergeTrackersEnabled"_s), false), m_isI2PEnabled{BITTORRENT_SESSION_KEY(u"I2P/Enabled"_s), false},
          m_I2PAddress{BITTORRENT_SESSION_KEY(u"I2P/Address"_s), u"127.0.0.1"_s}, m_I2PPort{BITTORRENT_SESSION_KEY(u"I2P/Port"_s), 7656},
          m_I2PMixedMode{BITTORRENT_SESSION_KEY(u"I2P/MixedMode"_s), false}, m_I2PInboundQuantity{BITTORRENT_SESSION_KEY(u"I2P/InboundQuantity"_s), 3},
          m_I2POutboundQuantity{BITTORRENT_SESSION_KEY(u"I2P/OutboundQuantity"_s), 3}, m_I2PInboundLength{BITTORRENT_SESSION_KEY(u"I2P/InboundLength"_s), 3},
          m_I2POutboundLength{BITTORRENT_SESSION_KEY(u"I2P/OutboundLength"_s), 3}, m_seedingLimitTimer{new QTimer(this)}, m_resumeDataTimer{new QTimer(this)},
          m_ioThread{new QThread}, m_asyncWorker{new QThreadPool(this)}, m_recentErroredTorrentsTimer{new QTimer(this)}
#if (QT_VERSION < QT_VERSION_CHECK(6, 0, 0))
...
#endif
{
    ...
    connect(Net::ProxyConfigurationManager::instance(), &Net::ProxyConfigurationManager::proxyConfigurationChanged, this, &SessionImpl::configureDeferred);
...
void SessionImpl::setLSDEnabled(const bool enabled) {
    if (enabled != m_isLSDEnabled) {
        ...
        configureDeferred();
        LogMsg(tr("Local Peer Discovery support: %1").arg(enabled ? tr("ON") : tr("OFF")), Log::INFO);
    }
}
...
void SessionImpl::prepareStartup() {
    ...
    connect(context->startupStorage, &ResumeDataStorage::loadStarted, context, [this, context](const QVector<TorrentID> &torrents) {
...
void SessionImpl::configurePeerClasses() {
    ...
    f.add_rule(lt::address_v4::any(), lt::address_v4::broadcast(), 1 << LT::toUnderlyingType(lt::session::global_peer_class_id));

    // IPv6 may not be available on OS and the parsing
    // would result in an exception -> abnormal program termination
    // Affects Windows XP
    try {
        f.add_rule(lt::address_v6::any(), lt::make_address("ffff:ffff:ffff:ffff:ffff:ffff:ffff:ffff"),
    ...
    if (ignoreLimitsOnLAN()) {
        // local networks
        f.add_rule(lt::make_address("10.0.0.0"), lt::make_address("10.255.255.255"), 1 << LT::toUnderlyingType(lt::session::local_peer_class_id));
        f.add_rule(lt::make_address("172.16.0.0"), lt::make_address("172.31.255.255"), 1 << LT::toUnderlyingType(lt::session::local_peer_class_id));
        f.add_rule(lt::make_address("192.168.0.0"), lt::make_address("192.168.255.255"), 1 << LT::toUnderlyingType(lt::session::local_peer_class_id));
        // link local
        f.add_rule(lt::make_address("169.254.0.0"), lt::make_address("169.254.255.255"), 1 << LT::toUnderlyingType(lt::session::local_peer_class_id));
        // loopback
        f.add_rule(lt::make_address("127.0.0.0"), lt::make_address("127.255.255.255"), 1 << LT::toUnderlyingType(lt::session::local_peer_class_id));
        ...
        try {
            // link local
            f.add_rule(lt::make_address("fe80::"), lt::make_address("febf:ffff:ffff:ffff:ffff:ffff:ffff:ffff"),
                       1 << LT::toUnderlyingType(lt::session::local_peer_class_id));
            // unique local addresses
            f.add_rule(lt::make_address("fc00::"), lt::make_address("fdff:ffff:ffff:ffff:ffff:ffff:ffff:ffff"),
                       1 << LT::toUnderlyingType(lt::session::local_peer_class_id));
            // loopback
            f.add_rule(lt::address_v6::loopback(), lt::address_v6::loopback(), 1 << LT::toUnderlyingType(lt::session::local_peer_class_id));
        }
        catch (const std::exception &) {}
    }
...
void SessionImpl::enableBandwidthScheduler() {
    if (!m_bwScheduler) {
        ...
        connect(m_bwScheduler.data(), &BandwidthScheduler::bandwidthLimitRequested, this, &SessionImpl::setAltGlobalSpeedLimitEnabled);
    }
    m_bwScheduler->start();
}
...
bool SessionImpl::deleteTorrent(const TorrentID &id, const DeleteOption deleteOption) {
    ...
    if (deleteOption == DeleteTorrent) {
        ...
        const auto iter = std::find_if(m_moveStorageQueue.begin(), m_moveStorageQueue.end(), [&nativeHandle](const MoveStorageJob &job) {
        ...
        if (m_moveStorageQueue.size() > 1) {
            ...
            const auto iter = std::find_if((m_moveStorageQueue.begin() + 1), m_moveStorageQueue.end(), [torrent](const MoveStorageJob &job) {
...
void SessionImpl::increaseTorrentsQueuePos(const QVector<TorrentID> &ids) {
    ...
    std::priority_queue<ElementType, std::vector<ElementType>, std::greater<ElementType>> torrentQueue;
...
bool SessionImpl::addTorrent(const QString &source, const AddTorrentParams &params) {
    ...
    if (Net::DownloadManager::hasSupportedScheme(source)) {
        ...
        const auto *pref = Preferences::instance();
        // Launch downloader
        Net::DownloadManager::instance()->download(Net::DownloadRequest(source).limit(pref->getTorrentFileSizeLimit()), pref->useProxyForGeneralPurposes(),
...
bool SessionImpl::addTorrent_impl(const std::variant<MagnetUri, TorrentInfo> &source, const AddTorrentParams &addTorrentParams) {
    ...
    if (Torrent *torrent = findTorrent(infoHash)) {
        ...
        if (isPrivate) {
            LogMsg(tr("Detected an attempt to add a duplicate torrent. Trackers cannot be merged because it is a private torrent. Torrent: %1").arg(
                    torrent->name()));
            return false;
        }
...
void SessionImpl::findIncompleteFiles(const TorrentInfo &torrentInfo, const Path &savePath, const Path &downloadPath, const PathList &filePaths) const {
...
void SessionImpl::saveResumeData() {
    ...
    while ((m_numResumeData > 0) || !m_moveStorageQueue.isEmpty() || m_needSaveTorrentsQueue) {
        ...
        if (timer.hasExpired(lt::total_milliseconds(expireTime)) && m_moveStorageQueue.isEmpty()) {
            LogMsg(tr("Aborted saving resume data. Number of outstanding torrents: %1").arg(QString::number(m_numResumeData)), Log::CRITICAL);
            break;
        }
...
void SessionImpl::setEncryption(const int state) {
    if (state != encryption()) {
        ...
        LogMsg(tr("Encryption support: %1").arg(
                state == 0 ? tr("ON") : ((state == 1) ? tr("FORCED") : tr("OFF"))), Log::INFO);
    }
}
...
bool SessionImpl::addMoveTorrentStorageJob(TorrentImpl *torrent, const Path &newPath, const MoveStorageMode mode, const MoveStorageContext context) {
    ...
    if (m_moveStorageQueue.size() > 1) {
        auto iter = std::find_if((m_moveStorageQueue.begin() + 1), m_moveStorageQueue.end(), [&torrentHandle](const MoveStorageJob &job) {
        ...
        if (iter != m_moveStorageQueue.end()) {
            ...
            LogMsg(tr("Torrent move canceled. Torrent: \"%1\". Source: \"%2\". Destination: \"%3\"").arg(torrent->name(), currentLocation.toString(),
                                                                                                         iter->path.toString()));
            m_moveStorageQueue.erase(iter);
        }
    }
    ...
    LogMsg(tr("Enqueued torrent move. Torrent: \"%1\". Source: \"%2\". Destination: \"%3\"").arg(torrent->name(), currentLocation.toString(),
                                                                                                 newPath.toString()));
...
void SessionImpl::handleMoveTorrentStorageJobFinished(const Path &newPath) {
    ...
    const auto iter = std::find_if(m_moveStorageQueue.cbegin(), m_moveStorageQueue.cend(), [&finishedJob](const MoveStorageJob &job) {
...
void SessionImpl::handleAddTorrentAlerts(const std::vector<lt::alert *> &alerts) {
    ...
    for (const lt::alert *a: alerts) {
...
#endif
            if (const auto loadingTorrentsIter = m_loadingTorrents.find(TorrentID::fromInfoHash(infoHash)); loadingTorrentsIter != m_loadingTorrents.end()) {
                m_loadingTorrents.erase(loadingTorrentsIter);
            } else if (const auto downloadedMetadataIter = m_downloadedMetadata.find(TorrentID::fromInfoHash(infoHash)); downloadedMetadataIter !=
                                                                                                                         m_downloadedMetadata.end()) {
                m_downloadedMetadata.erase(downloadedMetadataIter);
                if (infoHash.isHybrid()) {
        ...
        if (const auto loadingTorrentsIter = m_loadingTorrents.find(torrentID); loadingTorrentsIter != m_loadingTorrents.end()) {
        ...
        } else if (const auto downloadedMetadataIter = m_downloadedMetadata.find(torrentID); downloadedMetadataIter != m_downloadedMetadata.end()) {
...
void SessionImpl::handleTorrentDeleteFailedAlert(const lt::torrent_delete_failed_alert *p) {
    ...
    if (p->error) {
        ...
        LogMsg(tr("Removed torrent but failed to delete its content and/or partfile. Torrent: \"%1\". Error: \"%2\"")
                       .arg(removingTorrentDataIter->name, QString::fromLocal8Bit(p->error.message().c_str())), Log::WARNING);
...
void SessionImpl::handleFileErrorAlert(const lt::file_error_alert *p) {
    ...
    if (!m_recentErroredTorrents.contains(id)) {
        ...
        LogMsg(tr("File error alert. Torrent: \"%1\". File: \"%2\". Reason: \"%3\"")
                       .arg(torrent->name(), QString::fromUtf8(p->filename()), msg), Log::WARNING);
...
void SessionImpl::handleUrlSeedAlert(const lt::url_seed_alert *p) {
    ...
    if (p->error) {
        LogMsg(tr("URL seed DNS lookup failed. Torrent: \"%1\". URL: \"%2\". Error: \"%3\"")
                       .arg(torrent->name(), QString::fromUtf8(p->server_url()), QString::fromStdString(p->message())), Log::WARNING);
    } else {
        LogMsg(tr("Received error message from URL seed. Torrent: \"%1\". URL: \"%2\". Message: \"%3\"")
                       .arg(torrent->name(), QString::fromUtf8(p->server_url()), QString::fromUtf8(p->error_message())), Log::WARNING);
    }
}
...
void SessionImpl::handleListenFailedAlert(const lt::listen_failed_alert *p) {
    ...
    LogMsg(tr("Failed to listen on IP. IP: \"%1\". Port: \"%2/%3\". Reason: \"%4\"")
                   .arg(toString(p->address), proto, QString::number(p->port), QString::fromLocal8Bit(p->error.message().c_str())), Log::CRITICAL);
}
...
void SessionImpl::handleSocks5Alert(const lt::socks5_alert *p) const {
    if (p->error) {
        ...
        LogMsg(tr("SOCKS5 proxy error. Address: %1. Message: \"%2\".")
                       .arg(endpoint, QString::fromLocal8Bit(p->error.message().c_str())), Log::WARNING);
    }
}
