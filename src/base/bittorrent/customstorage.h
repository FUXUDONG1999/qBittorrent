...
public:
    ...
    void async_read(lt::storage_index_t storageIndex, const lt::peer_request &peerRequest,
                    std::function<void(lt::disk_buffer_holder, const lt::storage_error &)> handler, lt::disk_job_flags_t flags) override;

    bool async_write(lt::storage_index_t storageIndex, const lt::peer_request &peerRequest, const char *buf, std::shared_ptr<lt::disk_observer> diskObserver,
    ...
    void async_check_files(lt::storage_index_t storage, const lt::add_torrent_params *resume_data, lt::aux::vector<std::string, lt::file_index_t> links,
