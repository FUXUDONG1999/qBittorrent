...
inline QHash<QString, UIThemeColor> defaultUIThemeColors() {
    ...
    return {
            ...
            {u"Log.Normal"_s,                             {palette.color(QPalette::Active, QPalette::WindowText),   palette.color(QPalette::Active,
                                                                                                                                  QPalette::WindowText)}},
            ...
            {u"RSS.ReadArticle"_s,                        {palette.color(QPalette::Inactive, QPalette::WindowText), palette.color(QPalette::Inactive,
                                                                                                                                  QPalette::WindowText)}},
            {u"RSS.UnreadArticle"_s,                      {palette.color(QPalette::Active, QPalette::Link),         palette.color(QPalette::Active,
                                                                                                                                  QPalette::Link)}},
