...
TransferListWidget::TransferListWidget(QWidget *parent, MainWindow *mainWindow)
        : QTreeView{parent}, m_listModel{new TransferListModel{this}}, m_sortFilterModel{new TransferListSortModel{this}}, m_mainWindow{mainWindow} {
    // Load settings
...
void TransferListWidget::pauseAllTorrents() {
    if (Preferences::instance()->confirmPauseAndResumeAll()) {
        ...
        const QMessageBox::StandardButton ret = QMessageBox::question(this, tr("Confirm pause"), tr("Would you like to pause all torrents?"),
...
void TransferListWidget::resumeAllTorrents() {
    if (Preferences::instance()->confirmPauseAndResumeAll()) {
        ...
        const QMessageBox::StandardButton ret = QMessageBox::question(this, tr("Confirm resume"), tr("Would you like to resume all torrents?"),
                                                                      (QMessageBox::Yes | QMessageBox::No));
...
void TransferListWidget::recheckSelectedTorrents() {
    if (Preferences::instance()->confirmTorrentRecheck()) {
        QMessageBox::StandardButton ret = QMessageBox::question(this, tr("Recheck confirmation"),
                                                                tr("Are you sure you want to recheck the selected torrent(s)?"),
...
void TransferListWidget::exportTorrent() {
    ...
    connect(fileDialog, &QFileDialog::fileSelected, this, [this](const QString &dir) {
        ...
        if (hasError) {
            QMessageBox::warning(this, tr("Export .torrent file error"), tr("Errors occurred when exporting .torrent files. Check execution log for details."));
        }
    });
...
void TransferListWidget::displayListMenu() {
    ...
    auto *actionStart = new QAction(UIThemeManager::instance()->getIcon(u"torrent-start"_s, u"media-playback-start"_s),
    ...
    auto *actionPause = new QAction(UIThemeManager::instance()->getIcon(u"torrent-stop"_s, u"media-playback-pause"_s), tr("&Pause", "Pause the torrent"),
                                    listMenu);
    connect(actionPause, &QAction::triggered, this, &TransferListWidget::pauseSelectedTorrents);
    auto *actionForceStart = new QAction(UIThemeManager::instance()->getIcon(u"torrent-start-forced"_s, u"media-playback-start"_s),
    ...
    auto *actionBottomQueuePos = new QAction(UIThemeManager::instance()->getIcon(u"go-bottom"_s), tr("Move to &bottom", "i.e. Move to bottom of the queue"),
                                             listMenu);
    ...
    auto *actionForceReannounce = new QAction(UIThemeManager::instance()->getIcon(u"reannounce"_s, u"document-edit-verify"_s), tr("Force r&eannounce"),
                                              listMenu);
    ...
    categoryMenu->addAction(UIThemeManager::instance()->getIcon(u"list-add"_s), tr("&New...", "New category..."), this,
                            &TransferListWidget::askNewCategoryForSelection);
    categoryMenu->addAction(UIThemeManager::instance()->getIcon(u"edit-clear"_s), tr("&Reset", "Reset category"), this,
                            [this]() { setSelectionCategory(u""_s); });
    categoryMenu->addSeparator();

    for (const QString &category: asConst(categories)) {
        const QString escapedCategory = QString(category).replace(u'&', u"&&"_s);  // avoid '&' becomes accelerator key
        QAction *categoryAction = categoryMenu->addAction(UIThemeManager::instance()->getIcon(u"view-categories"_s), escapedCategory, this,
                                                          [this, category]() { setSelectionCategory(category); });
    ...
    tagsMenu->addAction(UIThemeManager::instance()->getIcon(u"list-add"_s), tr("&Add...", "Add / assign multiple tags..."), this,
                        &TransferListWidget::askAddTagsForSelection);
    tagsMenu->addAction(UIThemeManager::instance()->getIcon(u"edit-clear"_s), tr("&Remove All", "Remove all tags"), this, [this]() {
...
void TransferListWidget::applyStatusFilter(int f) {
    ...
    if (selectionModel()->selectedRows(0).empty() && (m_sortFilterModel->rowCount() > 0)) {
        ...
        selectionModel()->setCurrentIndex(m_sortFilterModel->index(0, TransferListModel::TR_NAME),
