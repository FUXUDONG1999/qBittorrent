...
TransferListModel::TransferListModel(QObject *parent)
        : QAbstractListModel{parent}, m_statusStrings
        {
                ...
                {BitTorrent::TorrentState::ForcedDownloadingMetadata, tr("[F] Downloading metadata",
                                                                         "Used when forced to load a magnet link. You probably shouldn't translate the F.")},
                {BitTorrent::TorrentState::ForcedDownloading,         tr("[F] Downloading",
                ...
                {BitTorrent::TorrentState::ForcedUploading,           tr("[F] Seeding",
                                                                         "Used when the torrent is forced started. You probably shouldn't translate the F.")},
                ...
                {BitTorrent::TorrentState::CheckingResumeData,        tr("Checking resume data",
        ...
        }, m_stateThemeColors{torrentStateColorsFromUITheme()}, m_checkingIcon{UIThemeManager::instance()->getIcon(u"force-recheck"_s, u"checking"_s)},
          m_completedIcon{UIThemeManager::instance()->getIcon(u"checked-completed"_s, u"completed"_s)},
          m_downloadingIcon{UIThemeManager::instance()->getIcon(u"downloading"_s)}, m_errorIcon{UIThemeManager::instance()->getIcon(u"error"_s)},
          ...
          m_queuedIcon{UIThemeManager::instance()->getIcon(u"queued"_s)}, m_stalledDLIcon{UIThemeManager::instance()->getIcon(u"stalledDL"_s)},
...
QString TransferListModel::displayValue(const BitTorrent::Torrent *torrent, const int column) const {
    ...
    const auto timeElapsedString = [hideValues](const qint64 elapsedTime, const qint64 seedingTime) -> QString {
        ...
        return tr("%1 (seeded for %2)", "e.g. 4m39s (seeded for 3m10s)")
                .arg(Utils::Misc::userFriendlyDuration(elapsedTime), Utils::Misc::userFriendlyDuration(seedingTime));
    };
